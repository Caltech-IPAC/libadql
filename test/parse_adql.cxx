...
int main (int argc, char *argv[])
{
  ...
  std::vector<std::string> pass = {
    ...
    "select ((ARRAY[10,20])[1]) from c", "select ARRAY[10,20][1], "
    ...
    "SELECT TAP_UPLOAD.pos.cntr as in_row_id, TAP_UPLOAD.pos.ra as in_ra, TAP_UPLOAD.pos.dec as in_dec, "
    ...
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(-90.0)),"
    ...
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(-180.0)),111194.68229846345*0.5,radians(90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(-90.0))])),ST_Point(wise.wise_allwise_p3am_cdd.ra2,wise.wise_allwise_p3am_cdd.dec2)) "
    "AND ST_Covers(ST_MakePolygon(ST_MakeLine(ARRAY["
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(-90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(-180.0)),111194.68229846345*0.5,radians(-90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(-180.0)),111194.68229846345*0.5,radians(90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(-90.0))])),ST_Point(wise.wise_allwise_p3am_cdd.ra3,wise.wise_allwise_p3am_cdd.dec3)) "
    "AND ST_Covers(ST_MakePolygon(ST_MakeLine(ARRAY["
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(-90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(-180.0)),111194.68229846345*0.5,radians(-90.0)),"
    "ST_Project(ST_Project(ST_Point(TAP_UPLOAD.pos.ra,TAP_UPLOAD.pos.dec), 111194.68229846345*0.5,radians(0.0)),111194.68229846345*0.5,radians(90.0)),"
  ...
  std::vector<std::string> fail = {
    ...
    "select atan2(a,) from a", "select atan2(a,b from a",
    "select round from a", "select round() from a", "select round(a,) from a",
