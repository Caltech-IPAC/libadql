...
int main()
{
  std::vector<std::string> inputs=
    {"POINT('foo',10 20)",
     ...
     "SELECT * FROM my_table WHERE CONTAINS(POINT('J2000',ra,my_table.dec),CIRCLE('J2000',+10 , -20,-1))",
     ...
     "SELECT * FROM mytable WHERE CONTAINS(POINT('J2000',dec,dec),CIRCLE('J2000',+10 , -20,-1))"};
