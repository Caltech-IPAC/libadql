...
inline std::ostream &operator<<(std::ostream &os,
                                const ADQL::Non_Predicate_Geometry_Function_One_Arg &non_predicate_geometry_function_one_arg)
{
  if (!non_predicate_geometry_function_one_arg.empty ())
      return os << non_predicate_geometry_function_one_arg.function << "(" << non_predicate_geometry_function_one_arg.arg << ")";
  return os;
}
}
