...
inline std::ostream &operator<<(std::ostream &os,
                                const ADQL::Non_Predicate_Geometry_Function_Two_Arg &non_predicate_geometry_function_two_arg)
{
  if (!non_predicate_geometry_function_two_arg.empty ())
      return os << non_predicate_geometry_function_two_arg.function << "(" << non_predicate_geometry_function_two_arg.arg0 << ',' << non_predicate_geometry_function_two_arg.arg1 << ")";
  return os;
}
}
