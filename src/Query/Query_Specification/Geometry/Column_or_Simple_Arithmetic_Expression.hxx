...
namespace ADQL
{
    typedef boost::variant<Column_Reference, Binary_Arithmetic_Expression, double> Column_or_Simple_Arithmetic_Expression;

class Column_or_Simple_Arithmetic_Expression_empty_Visitor : public boost::static_visitor<bool>
{
public:
...
class Column_or_Simple_Arithmetic_Expression_double_Visitor : public boost::static_visitor<double>
{
public:
  ...
  double operator()(const Column_Reference &c) const
  {
   ...
   double operator()(const Binary_Arithmetic_Expression &bae) const { return bae.evaluate(); }
};
