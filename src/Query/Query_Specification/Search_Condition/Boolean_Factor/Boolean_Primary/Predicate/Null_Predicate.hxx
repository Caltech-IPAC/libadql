...
inline std::ostream &operator<<(std::ostream &os, const ADQL::Null_Predicate &c) {
    return os << c.column << " IS " << (c.Not.empty() ? "" : "NOT ") << "NULL";
}
}  // namespace ADQL

BOOST_FUSION_ADAPT_STRUCT(ADQL::Null_Predicate, (ADQL::Value_Expression_Non_Bool_Wrap,
