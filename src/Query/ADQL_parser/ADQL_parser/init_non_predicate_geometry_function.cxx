...
void ADQL_parser::init_non_predicate_geometry_function ()
{
  ...
  non_predicate_geometry_function_one_arg %= (hold[lexeme[geo_one_arg_names >> &nonidentifier_character]]
                                              > '(' > point_or_column > ')');

  non_predicate_geometry_function_two_arg %= (hold[lexeme[geo_two_arg_names >> &nonidentifier_character]]
