...
void ADQL_parser::init_reserved_words() {
    ...
    ADQL_reserved_word %=
            ...
            ascii::no_case["SQRT"] | ascii::no_case["SIN"] | ascii::no_case["ROUND"] |
            ascii::no_case["REGION"] | ascii::no_case["RAND"] |
            ascii::no_case["RADIANS"] | ascii::no_case["POWER"] |
            ascii::no_case["POLYGON"] | ascii::no_case["POINT"] | ascii::no_case["PI"] |
            ascii::no_case["MOD"] | ascii::no_case["LOG10"] | ascii::no_case["LOG"] |
            ascii::no_case["INTERSECTS"] | ascii::no_case["FLOOR"] |
            ascii::no_case["EXP"] | ascii::no_case["DISTANCE"] |
    ...
    SQL_reserved_word_01 %=
            ...
            ascii::no_case["UNION"] | ascii::no_case["TRUE"] | ascii::no_case["TRIM"] |
            ascii::no_case["TRANSLATION"] | ascii::no_case["TRANSLATE"] |
            ascii::no_case["TRANSACTION"] | ascii::no_case["TRAILING"] |
            ascii::no_case["TO"] | ascii::no_case["TIMEZONE_MINUTE"] |
            ascii::no_case["TIMEZONE_HOUR"] | ascii::no_case["TIMESTAMP"];

    SQL_reserved_word_02 %= ascii::no_case["TIME"] | ascii::no_case["THEN"] |
    ...
    SQL_reserved_word_03 %= ascii::no_case["SESSION_USER"] | ascii::no_case["SESSION"] |
    ...
    SQL_reserved_word_10 %= ascii::no_case["PUBLIC"] | ascii::no_case["PROCEDURE"] |
    ...
    SQL_reserved_word_11 %=
            ascii::no_case["OPTION"] | ascii::no_case["OPEN"] | ascii::no_case["ONLY"] |
            ascii::no_case["ON"] | ascii::no_case["OF"] |
            ascii::no_case["OCTET_LENGTH"] | ascii::no_case["NUMERIC"] |
            ascii::no_case["NULLIF"] | ascii::no_case["NULL"] | ascii::no_case["NOT"] |
            ascii::no_case["NO"] | ascii::no_case["NEXT"] | ascii::no_case["NCHAR"] |
    ...
    SQL_reserved_word_13 %= ascii::no_case["JOIN"] | ascii::no_case["ISOLATION"] |
    ...
    SQL_reserved_word_21 %= ascii::no_case["FETCH"] | ascii::no_case["FALSE"] |
    ...
    SQL_reserved_word_22 %= ascii::no_case["DISTINCT"] | ascii::no_case["DISCONNECT"] |
                            ascii::no_case["DIAGNOSTICS"] |
                            ascii::no_case["DESCRIPTOR"] | ascii::no_case["DESCRIBE"] |
                            ascii::no_case["DESC"] | ascii::no_case["DELETE"] |
                            ascii::no_case["DEFERRED"] | ascii::no_case["DEFERRABLE"] |
                            ascii::no_case["DEFAULT"] | ascii::no_case["DECLARE"] |
                            ascii::no_case["DECIMAL"] | ascii::no_case["DEALLOCATE"] |
                            ascii::no_case["DAY"] | ascii::no_case["DATE"] |
    ...
    SQL_reserved_word_30 %= ascii::no_case["COLUMN"] | ascii::no_case["COLLATION"] |
    ...
    SQL_reserved_word_32 %= ascii::no_case["ALL"] | ascii::no_case["ADD"] |
                            ascii::no_case["ACTION"] | ascii::no_case["ABSOLUTE"];
