...
def build(ctx):
    ...
    cxx_sources=['src/Query/Query.cxx',
                 ...
                 'src/Query/Query_Specification/Numeric_Value_Expression/Term/Term_Wrap/ostream.cxx',
                 'src/Query/Query_Specification/Numeric_Value_Expression_Wrap/ostream.cxx',
                 'src/Query/Query_Specification/Numeric_Value_Expression/Term/Factor/Numeric_Primary/ostream.cxx',
                 'src/Query/Query_Specification/Numeric_Value_Expression/Term/Factor/Numeric_Primary/empty.cxx',
                 'src/Query/Query_Specification/Numeric_Value_Expression/Term/Factor/Numeric_Primary/Numeric_Value_Function/empty.cxx',
                 'src/Query/Query_Specification/Numeric_Value_Expression/Term/Factor/Numeric_Primary/Numeric_Value_Function/ostream.cxx',
                 'src/Query/Query_Specification/String_Value_Expression/Character_Factor/empty.cxx',
                 'src/Query/Query_Specification/String_Value_Expression/Character_Factor/ostream.cxx',
