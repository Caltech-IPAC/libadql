...
def options(ctx):
    ctx.load('compiler_cxx cxx17 gnu_dirs waf_unit_test')
...
def build(ctx):
    ...
    cxx_sources=['src/Query/Query.cxx',
                 ...
                 'src/Query/Query_Preprocessor/Query_Preprocessor.cxx',
                 'src/Query/Query_Preprocessor/Where_Clause_Normalizer/Where_Clause_Normalizer.cxx',
                 'src/Query/Query_Preprocessor/Top_Level_Parser/Top_Level_Parser.cxx',
